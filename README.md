...
This project is  the final assessment project for Udacity's React & Redux course. it was bootstrapped with [Create React App](https://github.com/facebookincubator/create-react-app).
